      ...
      htmlContent: (
        <section id='content'>
          ...
          <p class='section-intro-text'>
            Being sick can be a lot to manage!
          </p>
        </section>
      )
    },
    ...
    },
    {
      ...
      htmlContent: (
        <article id='Introduction'>
          ...
          <p>The purpose of this book is to reduce the amount of things you need to remember or manage when you are in hospital. That way you can focus on rest whilst feeling your recovery is moving in the right direction.</p>
<h1>What is this book?</h1>
<p>The book design is based on my experience and feedback from patients and healthcare professionals. It is designed to be;</p>
<p><strong>Simple: </strong> It should take 10 mins or less of simple reading before you can get started. 
</p>
<p><strong>An Organizer: </strong>All you need is a pen to start managing things more effectivly.</p>
